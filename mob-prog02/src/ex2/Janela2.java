	...
	public Janela2() {
		...
		btnExibir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				txtCadastro.setText(Lista.toString());
			}
		});
		
		btnExibir.setFont(new Font("Tahoma", Font.PLAIN, 13));
		btnExibir.setBounds(216, 304, 89, 23);
